...
rm -rf "$REL"
mkdir -p "$REL"
APK="$RUNNER_TEMP/g52/K_G1_Disposable_Photo_Probe_v0_5_2.apk"
LINT="$RUNNER_TEMP/g52/lint-results-debug.html"

python3 - <<'PY'
from pathlib import Path
import subprocess, zipfile
root=Path("source/v0.5.2")
out=Path("releases/v0.5.2/K_G1_Disposable_Photo_Probe_v0_5_2_source_v1.zip")
...
cp "$APK" "$REL/K_G1_Disposable_Photo_Probe_v0_5_2.apk"
cp "$LINT" "$REL/lint-results-debug.html"
sha256sum "$REL/K_G1_Disposable_Photo_Probe_v0_5_2.apk" > "$REL/K_G1_Disposable_Photo_Probe_v0_5_2_APK_SHA256.txt"
sha256sum "$REL/K_G1_Disposable_Photo_Probe_v0_5_2_source_v1.zip" > "$REL/K_G1_Disposable_Photo_Probe_v0_5_2_source_SHA256.txt"
...
rm -rf "$RUNNER_TEMP/g52pkg"
mkdir -p "$RUNNER_TEMP/g52pkg"
cp "$REL"/* "$RUNNER_TEMP/g52pkg/"
(cd "$RUNNER_TEMP/g52pkg" && zip -q -r "$GITHUB_WORKSPACE/$REL/K_G1_Disposable_Photo_Probe_v0_5_2_package.zip" .)
sha256sum "$REL/K_G1_Disposable_Photo_Probe_v0_5_2_package.zip" > "$REL/K_G1_Disposable_Photo_Probe_v0_5_2_package_SHA256.txt"
