package com.parkarsite.g1catalogshapeprobe4;
...
public final class MainActivity extends Activity {
    ...
    private void buildUi(){
        ...
        TextView t=new TextView(this); t.setText("K G1 Catalog Shape Probe v0.4.4"); t.setTextSize(24); root.addView(t);
    ...
    private void runProbe(){
        ...
        append("Catalog fingerprint/hash logging: DISABLED");
    ...
    private static final class CatalogSummary{
        ...
        String contentType="<none>",contentEncoding="<none>",bom="NONE";
