...
JAVA="$SRC/java/com/parkarsite/g1catalogshapeprobe4/MainActivity.java"
...
grep -Fq 'Catalog fingerprint/hash logging: DISABLED' "$JAVA" || { echo "FAIL: catalog fingerprint redaction declaration missing"; fail=1; }
