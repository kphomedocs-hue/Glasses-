...
JAVA="$SRC/java/com/parkarsite/g1singlephotoprobe56/MainActivity.java"
MANIFEST="$SRC/AndroidManifest.xml"
fail=0
bad(){ if grep -RniE "$1" "$SRC" >/tmp/g56_hits 2>/dev/null; then echo "FAIL: $2"; cat /tmp/g56_hits; fail=1; else echo "PASS: $2 absent"; fi; }
