# K G1 Catalog Shape Probe v0.4.3 — G4B2
...
v0.4.3 uses a fresh package ID `com.parkarsite.g1catalogshapeprobe` so it installs separately from v0.4.2 despite GitHub debug signing.
